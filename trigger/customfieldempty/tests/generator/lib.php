...
/**
 * lifecycletrigger_customfieldempty generator tests
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class generator extends \testing_module_generator {
     ...
     */
    public static function create_trigger_with_workflow($customfieldshortname, $invert) {
        // Create Workflow.
        $record = new \stdClass();
        $record->id = null;
        ...
        // Create trigger.
        $record = new \stdClass();
        $record->subpluginname = 'customfieldempty';
        $record->instancename = 'customfieldempty';
