 ...
 */
class reject_course_form extends moodleform {
    #[\Override]
    public function definition() {
        ...
        $mform->addElement('header', 'coursedetails',
                get_string('coursereasonforrejecting', 'lifecyclestep_departmentapprove'));

        $mform->addElement(
            'textarea',
            'rejectnotice',
            get_string('coursereasonforrejectingemail', 'lifecyclestep_departmentapprove'),
            ['rows' => '15', 'cols' => '50'],
        );
