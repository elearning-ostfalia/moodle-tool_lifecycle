...
namespace lifecyclestep_duplicate2;

use tool_lifecycle\local\manager\process_manager;
use tool_lifecycle\local\manager\settings_manager;
use tool_lifecycle\settings_type;
use tool_lifecycle\step\interactionduplicate2;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class form_duplicate2 extends \moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('text', $elementname, get_string('shortnamecourse'), ['size' => 30]);
        $mform->addHelpButton($elementname, 'shortnamecourse');
        $mform->setType($elementname, PARAM_TEXT);

        $elementname = 'fullname';
        $mform->addElement('text', $elementname, get_string('fullnamecourse'), ['size' => 60]);
    ...
    public function definition_after_data() {
        ...
        $mform->setDefault('fullname', $course->fullname . ' new');
        $mform->setDefault('shortname', $course->shortname . '_new');
    }
}
